        ...
        <div class="flex-container">
            <c:forEach var="l" items="${search}">
                ...
                <div class="card" style="width: 10rem;">
                    ...
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#a${l.isbn}"><i class="fa fa-search"></i><span class="glyphicon glyphicon-eye-open"></span> Fiche du livre</button>
